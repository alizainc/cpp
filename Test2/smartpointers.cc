...
SPointer::SPointer(const SPointer& c)
    : pointer(c.pointer), refCount(c.refCount), lth(c.lth)
{
...
/*
 * sp1 pointer is 0x2143010 string is "This is a test", refCount 3
 * sp2 pointer is 0x2143010 string is "This is a test", refCount 3
 * sp3 pointer is 0x2143010 string is "This is a test", refCount 3
 *
 * sp1 pointer is 0x2143070 string is "Another test", refCount 1
 * sp2 pointer is 0x2143010 string is "This is a test", refCount 2
 * sp3 pointer is 0x2143010 string is "This is a test", refCount 2
 *
 * sp1 pointer is 0x2143070 string is "Another test", refCount 1
 * sp2 pointer is 0x21430f0 string is "Khis is a test", refCount 1
 * sp3 pointer is 0x2143010 string is "This is a test", refCount 1
 *
 * AllocCount is  4
 * DeleteCount is 4
 */
